...
export default function PropertyCard({ property, clickable = true }: PropertyCardProps) {
  ...
  if (clickable) {
    ...
    return (
      <article
        className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden transition-transform duration-200 w-full"
        aria-label={`Property: ${property.title}`}
        role="article"
      >
        <div className="relative w-full aspect-[2/1] bg-gray-100 dark:bg-gray-700">
