  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Popular Listings</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-0">Likely to sell in the next month based on price, listing date, and property details.</p>
        <FeaturedPropertiesCarousel properties={featuredByPrice} />
        {/* Carousel 2: Most Bedrooms */}
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mt-12">Homes with the Most Bedrooms</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-0">Spacious homes for large families or those who love extra room.</p>
