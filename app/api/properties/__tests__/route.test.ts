...
describe('Properties API', () => {
  ...
  describe('POST /api/properties', () => {
    ...
    it('creates a new property', async () => {
      const createdProperty = { id: 1, ...mockProperty, createdAt: new Date(), updatedAt: new Date() };
  ...
  describe('PATCH /api/properties/[id]', () => {
    ...
    it('returns 404 for non-existent property', async () => {
      (prisma.property.update as jest.Mock).mockRejectedValue(new Error('Record not found'));
  ...
  describe('DELETE /api/properties/[id]', () => {
    ...
    it('returns 404 for non-existent property', async () => {
      (prisma.property.delete as jest.Mock).mockRejectedValue(new Error('Record not found'));
